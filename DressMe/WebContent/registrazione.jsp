			...
			$.ajax(
				{
					...
					success: (data) => {
						window.location.replace("http://localhost:8080/DressMe/successoRegistrazione.jsp");
					},
					error: (data) => {
						$("#signin-message").html("OPS!!È stato commesso un errore Email già esistente riprovare");
